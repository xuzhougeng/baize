...
func TestNormalizedVersionBase(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "plain tag", input: "v0.6.0", want: "v0.6.0"},
		{name: "git describe suffix", input: "v0.6.0-3-gabc1234", want: "v0.6.0"},
		{name: "dirty git describe", input: "v0.6.0-3-gabc1234-dirty", want: "v0.6.0"},
